...
var mongoURL = 'mongodb://root:root12@ds143245.mlab.com:43245/blockchain';
...
exports.updateMany = function(collectionName, queryJSON, updateJSON, callback){
    var connectionFromPool = p.getConnection();
    var db = connectionFromPool[0].poolObject;
    var connectionLocation = connectionFromPool[0].poolObjectLocation;

    var collectionObject = db.collection(collectionName);
    collectionObject.updateMany(queryJSON, updateJSON, callback);//native object call for NPM
    p.releaseConnection(connectionLocation);
//		db.close();
};
