...
router.post('/getaccessrules', function (req, res, next) {
    console.log("from node get access rules------------------------------------------ ");
    console.log(req.body);
    //Select * from accessRules where accessRules.userId = (select userId from userInfo where email = 'pranithkouda@gmail.com')
    let getUser = "select * from userInfo where email='" +req.body["email"] + "'";
    let getAccessRules = "select * from accessRules where accessRules.userId = (select userId from userInfo where email = '" +req.body.email + "')";
    mysql.fetchData(function (err, results) {
        if (err) {
            console.log(
                err
